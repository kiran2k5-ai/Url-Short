                    ...
                    <div className="flex gap-3">
                        ...
                        <div>
                            ...
                            <ul className="text-sm text-blue-800 space-y-1">
                                <li>• Column 1: <strong>originalUrl</strong> (required)</li>
                                <li>• Column 2: <strong>customAlias</strong> (optional)</li>
                                <li>• Column 3: <strong>expiryDays</strong> (optional)</li>
                                <li>• Column 4: <strong>expiryDate</strong> (optional, format: YYYY-MM-DD)</li>
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="bg-white rounded-2xl shadow-lg p-6 sticky top-6">
                            ...
                            <div className="border-t pt-4 mt-4">
                                ...
                                <div className="bg-gray-50 rounded p-3 text-xs font-mono text-gray-700 space-y-1">
                                    <p>originalUrl,customAlias,expiryDays,expiryDate</p>
                                    <p className="text-gray-500">https://example.com,example,30,</p>
                                    <p className="text-gray-500">https://github.com,github,,2026-07-01</p>
