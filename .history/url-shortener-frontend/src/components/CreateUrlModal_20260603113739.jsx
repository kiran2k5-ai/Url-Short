			...
			{isOpen ? (
				...
				>
					<motion.div
						...
						className="max-h-[92vh] w-full max-w-4xl overflow-y-auto rounded-[32px] border border-white/60 bg-white shadow-[0_24px_100px_rgba(15,23,42,0.24)] dark:border-white/10 dark:bg-slate-950"
					>
						...
						<div className="grid gap-6 px-6 py-6 lg:grid-cols-[1.2fr_0.8fr]">
							<form onSubmit={handleSubmit} className="space-y-5">
								...
								<button
									type="submit"
									disabled={loading}
									className="inline-flex items-center gap-2 rounded-2xl bg-gradient-to-r from-[#5B4BFF] to-[#7C6CFF] px-5 py-3.5 text-sm font-semibold text-white shadow-lg shadow-[#5B4BFF]/20 transition hover:scale-[1.01] disabled:cursor-not-allowed disabled:opacity-60"
								>
									<FiLink2 size={16} />
							...
							<div className="space-y-5 rounded-[28px] bg-gradient-to-br from-[#5B4BFF]/5 to-[#7C6CFF]/10 p-5 dark:from-[#5B4BFF]/10 dark:to-[#7C6CFF]/10">
								<div className="rounded-[24px] border border-white/70 bg-white p-5 shadow-sm dark:border-white/10 dark:bg-slate-900">
								...
								{createdPayload?.shortUrl ? (
									<div className="space-y-4 rounded-[24px] border border-emerald-200 bg-emerald-50 p-5 dark:border-emerald-500/30 dark:bg-emerald-500/10">
										<div>
										...
										<div className="flex justify-center rounded-[24px] bg-white p-4 dark:bg-slate-950">
