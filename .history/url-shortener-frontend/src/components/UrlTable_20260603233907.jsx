...
function UrlTable({ urls, onCopy, onEdit, onDelete, onAnalytics }) {
	...
	return (
		<div className="rounded-[32px] border border-white/60 bg-white/85 shadow-[0_20px_80px_rgba(15,23,42,0.08)] backdrop-blur-xl dark:border-white/10 dark:bg-slate-950/70">
						...
						{urls.map((url) => {
							...
							return (
								<motion.tr key={url._id} initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="transition hover:bg-slate-50/70 dark:hover:bg-white/5">
									<td className="max-w-[280px] px-5 py-4 align-top text-sm text-slate-700 dark:text-slate-200">
