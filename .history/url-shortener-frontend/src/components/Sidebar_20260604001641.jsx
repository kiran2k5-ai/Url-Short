...
const navItems = [
	...
	{ label: "Analytics", to: "/analytics/overview", icon: FiBarChart2 },
		...
		<div className="flex h-full flex-col bg-[#111827] text-white">
			<div className="border-b border-white/10 px-6 py-6">
				<div className="flex items-center gap-3">
					<div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-linear-to-br from-[#5B4BFF] to-[#7C6CFF] text-lg font-bold shadow-lg shadow-[#5B4BFF]/30">
						U
					</div>
					<div>
