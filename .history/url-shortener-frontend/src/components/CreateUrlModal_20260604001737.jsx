						...
						<div className="grid gap-6 px-6 py-6 lg:grid-cols-[1.2fr_0.8fr]">
							...
							<div className="space-y-5 rounded-3xl bg-linear-to-br from-[#5B4BFF]/5 to-[#7C6CFF]/10 p-5 dark:from-[#5B4BFF]/10 dark:to-[#7C6CFF]/10">
								...
								{createdPayload?.shortUrl ? (
									...
									<div className="rounded-3xl border border-dashed border-slate-200 bg-white p-5 text-sm leading-6 text-slate-500 dark:border-white/10 dark:bg-slate-900 dark:text-slate-400">
