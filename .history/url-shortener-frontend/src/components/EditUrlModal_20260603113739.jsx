			...
			{isOpen && url ? (
				...
				>
					<motion.div
						...
						className="w-full max-w-2xl rounded-[32px] border border-white/60 bg-white shadow-[0_24px_100px_rgba(15,23,42,0.24)] dark:border-white/10 dark:bg-slate-950"
					>
						...
						<form onSubmit={handleSubmit} className="space-y-5 px-6 py-6">
							...
							<div className="flex items-center justify-end gap-3 pt-2">
								...
								<button
									type="submit"
									disabled={loading}
									className="inline-flex items-center gap-2 rounded-2xl bg-gradient-to-r from-[#5B4BFF] to-[#7C6CFF] px-4 py-2.5 text-sm font-semibold text-white shadow-lg shadow-[#5B4BFF]/20 transition hover:scale-[1.01] disabled:opacity-60"
								>
									<FiSave size={16} />
