...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 px-6 py-10 text-slate-900 dark:bg-slate-950 dark:text-white">
      <div className="mx-auto max-w-6xl rounded-[32px] border border-slate-200/80 bg-white/95 p-10 shadow-[0_30px_90px_rgba(15,23,42,0.08)] dark:border-slate-700/60 dark:bg-slate-900/90">
