...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 dark:bg-slate-950 dark:text-white">
      <div className="mx-auto grid min-h-screen max-w-[1440px] grid-cols-1 lg:grid-cols-[1.14fr_0.86fr]">
        ...
        <main className="flex items-center justify-center bg-slate-50 px-6 py-12 dark:bg-slate-950 lg:px-12">
          <div className="w-full max-w-md rounded-[32px] border border-slate-200/80 bg-white/95 p-10 shadow-[0_30px_90px_rgba(15,23,42,0.08)] backdrop-blur-xl dark:border-slate-700/60 dark:bg-slate-900/90">
            <div className="mb-8">
