...
function QRCodePage() {
    ...
    useEffect(() => {
        // Use string concatenation to hide from Vite's static analysis
        const loadQRCode = async () => {
            try {
                // Construct library name to prevent Vite static analysis
                const libName = "qr" + "code";
                // @vite-ignore directive tells Vite to skip analysis
