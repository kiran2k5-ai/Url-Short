    ...
    return (
        <div className="grid min-h-screen lg:grid-cols-[1.05fr_0.95fr]">
            <div className="hidden overflow-hidden p-6 lg:block">
                <div className="relative flex h-full min-h-[calc(100vh-3rem)] items-end overflow-hidden rounded-[40px] bg-[radial-gradient(circle_at_top_left,_rgba(255,255,255,0.2),_transparent_38%),linear-gradient(135deg,_#111827,_#0F172A_52%,_#7C6CFF)] p-10 text-white shadow-[0_30px_120px_rgba(15,23,42,0.3)]">
