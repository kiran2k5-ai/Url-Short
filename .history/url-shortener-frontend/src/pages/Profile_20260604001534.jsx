            ...
            <div className="p-6 md:p-8">
                ...
                <div className="mt-8 md:mt-10 bg-white rounded-3xl shadow-lg p-6 md:p-8">
                    ...
                    <div className="flex flex-col md:flex-row items-center md:items-start gap-6 md:gap-10">
                        ...
                        <div className="w-24 h-24 md:w-32 md:h-32 rounded-full bg-linear-to-br from-indigo-400 to-indigo-600 flex items-center justify-center text-white font-bold text-4xl md:text-5xl shadow-lg">
                            {user.name.charAt(0)}
                        </div>
