    ...
    return (
        <div className="grid min-h-screen lg:grid-cols-[0.95fr_1.05fr]">
            ...
            <div className="hidden overflow-hidden p-6 lg:block">
                <div className="relative flex h-full min-h-[calc(100vh-3rem)] items-end overflow-hidden rounded-[40px] bg-[radial-gradient(circle_at_top_left,_rgba(255,255,255,0.2),_transparent_38%),linear-gradient(135deg,_#0F172A,_#111827_48%,_#5B4BFF)] p-10 text-white shadow-[0_30px_120px_rgba(15,23,42,0.3)]">
