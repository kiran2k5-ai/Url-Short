            ...
            try {
                ...
                for (let i = 1; i < lines.length; i++) {
                    ...
                    try {
                        ...
                        uploadResults.errors.push({ row: i + 1, url: parts[urlIndex], error: "Failed to create URL" });
                    }
                }
                setResults(uploadResults);
                if (uploadResults.success > 0) toast.success(`${uploadResults.success} URLs created`);
