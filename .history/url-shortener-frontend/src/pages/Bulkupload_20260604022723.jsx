...
https://github.com/myproject,github-proj,60
        ...
        return new Promise((resolve, reject) => {
            ...
            reader.onload = (e) => {
                try {
                    ...
                    if (urlIndex === -1) {
                        reject(new Error('CSV must contain "Original URL" column'));
                    }
                    ...
                    for (let i = 1; i < lines.length; i++) {
                        ...
                        rows.push({
                            ...
                            customCode: parts[codeIndex] || undefined,
                            expiryDays: parts[expiryIndex]
                                ? parseInt(parts[expiryIndex])
                                : undefined,
                        });
                    }
            ...
            for (let i = 0; i < rows.length; i++) {
                try {
                    const result = await createUrl({
                        ...
                        customCode: rows[i].customCode,
                        expiryDays: rows[i].expiryDays || 30,
                    });
