  ...
  return (
    <div className="min-h-screen bg-white text-slate-900">
      <div className="mx-auto grid min-h-screen max-w-7xl grid-cols-1 lg:grid-cols-2">
        <section className="relative overflow-hidden bg-gradient-to-br from-[#5b4bff] to-[#6d5fdf] px-8 py-16 text-white sm:px-16 sm:py-24">
          ...
          <div className="pointer-events-none absolute inset-0">
            ...
            <div className="absolute left-0 bottom-20 h-80 w-80 rounded-full bg-white/5 blur-3xl" />
          </div>
        </section>
