  ...
  return (
    <div className="min-h-screen bg-white text-slate-900">
      <div className="mx-auto grid min-h-screen max-w-7xl grid-cols-1 lg:grid-cols-2">
        <section className="relative overflow-hidden bg-gradient-to-br from-[#5b4bff] to-[#6d5fdf]  text-white sm:px-16 sm:py-24">
          <div className="relative  flex flex-col justify-between min-h-full">
            <div>
              <div className="inline-flex items-center rounded-full bg-white/15  py-2 text-sm font-semibold">
