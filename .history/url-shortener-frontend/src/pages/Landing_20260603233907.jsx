...
import { FiArrowRight, FiBarChart2, FiCheckCircle, FiLock, FiUpload, FiZap } from "react-icons/fi";
...
const featurePillars = [
    ...
    { icon: TbQrcode, title: "QR ready", description: "Generate QR codes alongside every short link for offline and print use." },
